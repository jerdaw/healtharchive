...
- `frontend/` owns the frontend-specific subset:
...
- **Architecture & project state:**
  Detailed documentation is now unified in the monorepo docs hub.
  Run `make docs-serve` at the repo root to view the full Implementation Guide, i18n instructions, and deployment runbooks.
