...
expected_timer_specs=(
  ...
  "healtharchive-crawl-auto-recover.timer|crawl-auto-recover-enabled|false|"
  "healtharchive-crawl-metrics.timer||false|"
  "healtharchive-cleanup-automation.timer|cleanup-automation-enabled|false|REQUIRE_CLEANUP_AUTOMATION"
  "healtharchive-db-backup.timer||false|"
  "healtharchive-disk-check.timer||false|"
  "healtharchive-disk-threshold-cleanup.timer|cleanup-automation-enabled|false|"
  "healtharchive-docker-runtime-metrics.timer||false|"
