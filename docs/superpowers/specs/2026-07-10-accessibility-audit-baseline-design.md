...
Use a stacked branch based on the architecture-diagrams documentation branch
so the planning indexes remain conflict-free. Open a PR against that branch. No deployment,
