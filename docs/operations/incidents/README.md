...
- [API search/changes 500 due to missing dedupe migration (2026-02-06)](2026-02-06-api-search-changes-500-missing-migration.md)
- [Auto-recover stall detection bugs (2026-02-06)](2026-02-06-auto-recover-stall-detection-bugs.md)
...
6) If this incident changes user expectations (outage/degradation, integrity risk, security posture, policy change), add a **public-safe** note in `/changelog` and/or `/status` (no sensitive details; changelog process: https://github.com/jerdaw/healtharchive/blob/main/frontend/docs/changelog-process.md).
