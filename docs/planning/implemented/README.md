...
- `2026-07-10-status-availability-communication.md`
...
- **Compressed format:** Plans >200 lines should be compressed to summary format (~40-80 lines) after implementation. See `docs/documentation-guidelines.md` for the template.
- **Dated filenames:** Use `YYYY-MM-DD-<short-slug>.md`.
- **Canonical docs first:** Ensure outcomes are captured in canonical docs under `docs/deployment/`, `docs/operations/`, or `docs/development/`. The plan here serves as supporting history.
- **Historical detail:** Detailed phase-by-phase narratives are preserved in git history.
- **Minimal edits:** Treat these as a record; avoid ongoing edits except for small errata.
